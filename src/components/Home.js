  ...
  return (
    <div className="home-container">
      <div className="home-content">
        ...
        <p>
          To provide world-class healthcare services at affordable costs, in all medical departments.
        </p>
      </div>
